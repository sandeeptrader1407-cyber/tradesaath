const features = [
  ...
  { icon: '🗺', bg: 'rgba(245,166,35,.1)', title: 'AI Coach', desc: 'Daily, weekly, monthly & quarterly improvement plans. Actionable steps with stop/do/practice tags. Personalised roadmap.', border: 'rgba(245,166,35,.25)', badge: 'PRO' },
