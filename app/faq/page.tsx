...
const FAQS: FAQ[] = [
  ...
  { cat: 'getting-started',
    ...
    a: '30+ brokers across India, US, UK, Singapore, and the EU — including Zerodha, Interactive Brokers, TD Ameritrade, Upstox, Robinhood, eToro, Saxo, IG Markets, and more. CSV, Excel, PDF, and image files all auto-detected.' },
  { cat: 'getting-started',
  ...
  { cat: 'trading',
    ...
    a: 'Yes. Core KPIs and most behavioral patterns work across options, equity, commodity, and crypto. Some derivative-specific patterns (like expiry-day oversizing) only trigger on F&O trades — Nifty, SPX, FTSE options, etc.' },
  { cat: 'account',
